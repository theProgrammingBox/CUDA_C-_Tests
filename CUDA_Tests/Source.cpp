...
struct GpuMemoryManager
{
	...
	void allocateStatic(u32 tensorIdx, f64& bestScore, std::vector<MemoryData*>& bestCombination)
	{
	...
	void allocateDynamic(u32 tensorIdx, f64& bestScore, std::vector<MemoryData*>& bestCombination)
	{
